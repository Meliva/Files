...
public class Screen extends Application //extends BackProgram
{
	...
	protected Button exitB = new Button("Exit");//Exits to main screen
	...
	public void start(Stage stage) throws Exception 
	{
		...
		exitB.setOnAction((e)->
		{
			...
			update.setHeaderText(null);
			update.setContentText("Exit and save?");
		...
		HBox mid = new HBox(exitB,resB);
		mid.setStyle("-fx-alignment: center;-fx-spacing:10");
		VBox root = new VBox(topTop,top,mid);
